    ...
    return h("r-l-client-table", {
      ...
      scopedSlots: {
        "default": function _default(props) {
          ...
          }, [props.slots.beforeFilter, h("vt-generic-filter"), props.slots.afterFilter]) : '', props.slots.afterFilterWrapper, (props.perPageValues.length > 1 || props.opts.alwaysShowPerPageSelect) && !props.opts.pagination.virtual ? h("div", {
